...
public class msg2Driver {
	...
	//public FirefoxProfile profile,profile2,profile3,profile4, profile5, profile6;
	...
	public void tgBot() {
		...
		*/
		...
		while (true) {
			...
			if (exited == true) {
				System.out.println("Newloop after exit Thread msg2");
...
//						TimeUnit.MILLISECONDS.sleep(500);
						...
						// Slowmode groups
						if (group =="-1310700854" ||group== "-1131831039" || group == "-1207243227" || group == "-1415725598" || group == "-1376683114"
...
//									.click();
//							System.out.println("Msg2 sent to group: " + group);
//							driver.shillCounter++;
//							driver.counterTabs.setText("Total Shills: " + driver.shillCounter);
							...
							List<WebElement> forwardedMessages = SeleniumBot
									.findElements(By.cssSelector("div[data-timestamp='" + "1627040931" + "']"));
...
//			scroller.sendKeys(Keys.PAGE_DOWN);
						...
						System.out.println("Msg2 sent to group: " + group + "    Profile: " +webDriver.currentProfile);
						driver.shillCounter2++;
						driver.counterTabs.setText("Total Shills: " +"1: "+ driver.shillCounter + " 2: "+ driver.shillCounter2+ " 3:"
						+ driver.shillCounter3+ " 4:"+driver.shillCounter4 + "    Profile: " +webDriver.currentProfile);
						...
						System.out.println("Message 2 : Failed for group: " + group);
			...
			SeleniumBot.quit();	
			//Selenium.quit();
			System.out.println("Closed afteer Msg2");
